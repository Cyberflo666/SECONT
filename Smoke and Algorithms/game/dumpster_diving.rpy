...
label dumpster_diving_minigame2_start :
    hide screen phone_icon
    call screen dumpster_diving_minigame2_1 # Calling a screen hides the dialogue box

label dumpster_diving_minigame2_completed_1:
    $ diving1completed = True
    scene bg dumpster diving 1 finished
    pause 1.5
    scene bg new kitchen
    ...
    call screen dumpster_diving_minigame2_2

label dumpster_diving_minigame2_completed_2:
    $ diving1completed = True
    scene bg dumpster diving 1 finished
    pause 1.5
    scene bg new kitchen
...
# Variables
define placement_sens = 20 # How sensitive the pieces must be aligned with their assigned spot (lower is more sensitive)
define dd1_pieces_total_2 = 7
default dd1_pieces_completed_2 = 0
define dd1_piece_pos_goal_2 = [(92, 28), (92, 137), (299, 28), (338, 216), (92, 345), (92, 553), (335, 654)]
define dd1_piece_pos_initial_2 = [(1050, 140), (1020, 160), (1010, 130), (1100, 250), (1030, 180), (960, 150), (1000, 150)]

screen dumpster_diving_minigame2_1:
    image "images/objects/dumpster diving/bg dumpster diving 1.png"

    draggroup:
        # Draggable image pieces
        for i in range(dd1_pieces_total_2):
            drag:
                drag_name i
                pos dd1_piece_pos_initial_2[i]
...
define dd2_pieces_total_2 = 7
default dd2_pieces_completed_2 = 0
define dd2_piece_pos_goal_2 = [(92, 28), (92, 137), (299, 28), (338, 216), (92, 345), (92, 553), (335, 654)]
define dd2_piece_pos_initial_2 = [(1050, 140), (1020, 160), (1010, 130), (1100, 250), (1030, 180), (960, 150), (1000, 150)]

screen dumpster_diving_minigame2_2:
    image "images/objects/dumpster diving/bg dumpster diving 1.png"

    draggroup:
        # Draggable image pieces
        for i in range(dd2_pieces_total_2):
            drag:
                drag_name i
                pos dd2_piece_pos_initial_2[i]
...
init python:
    ...
    # Function called when one of the dragged_pieces is being dropped onto on of the snap_spots
    def dropped_onto(snap_spot, dragged_piece):
        global dd1_pieces_completed_2
        global dd2_pieces_completed_2
        ...
        if snap_spot.drag_name == dragged_piece[0].drag_name:
            ...
            if distance < placement_sens:
                ...
                if diving1completed == True:
                    dd2_pieces_completed_2 +=1
                    if dd2_pieces_completed_2 == dd2_pieces_total_2:
                        renpy.jump("dumpster_diving_minigame2_completed_2")
                else:
                    dd1_pieces_completed_2 += 1
                    if dd1_pieces_completed_2 == dd1_pieces_total_2:
                        renpy.jump("dumpster_diving_minigame2_completed_1")